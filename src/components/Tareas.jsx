  ...
  const actividades = [
    { 
      ...
      description: `Juego de preguntas tipo test sobre el texto A dado en el apartado de recursos. 
                              Ética a Nicómaco de Aristóteles: La Felicidad.
                              Mucha suerte.`,
    ...
    { 
      id: 2, 
      title: "Actividad 2", 
      description: `Dictado; el objetivo de esta actividad es interiorizar cómo se hace un comentario de texto en
                              los exámenes de acceso universitario, sobre el “texto A” dado en el apartado de recursos.
                              Ética a Nicómaco de Aristóteles: La Felicidad
                              Mucha suerte.`,
    ...
    { 
      id: 3, 
      title: "Actividad 3", 
      description:  `Completa el “texto B” Aristóteles. Política, Libro I, Capítulo II. Gredos, 
                              con los conceptos elementales del texto.
                              Mucha suerte.`,
     ...
     { 
      id: 4, 
      title: "Actividad 4", 
      description: `Ahorcados: según la definición expuesta, adivina la palabra relacionada 
                                como concepto central del “Texto B”, puedes recurrir a las pistas. 
